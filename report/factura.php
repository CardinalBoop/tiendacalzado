...
$sCliente=ejecutarSQL::consultar("SELECT * FROM cliente WHERE RUT='".$dVenta['RUT']."'");
...
$pdf->Cell (0,5,utf8_decode('Calzados Cortesi'),0,1,'C');
$pdf->Ln(5);
...
$pdf->Ln(12);
$pdf->SetFont("Times","b",12);
$pdf->Cell (30,5,utf8_decode('RUT: '),0);
$pdf->SetFont("Times","",12);
$pdf->Cell (25,5,utf8_decode($dCliente['RUT']),0);
$pdf->Ln(12);
$pdf->SetFont("Times","b",12);
...
$pdf->Cell (30,10,utf8_decode('Talla'),1,0,'C');
...
while($fila1 = mysqli_fetch_array($sDet, MYSQLI_ASSOC)){
    ...
    $pdf->Cell (30,10,utf8_decode($fila1['TallaProducto']),1,0,'C');
...
$pdf->Cell (30,10,utf8_decode(''),1,0,'C');
$pdf->Cell (30,10,utf8_decode('$'.number_format($suma,0)),1,0,'C');
$pdf->Ln(10);

    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>PEDIDOS <small class="tittles-pages-logo">CALZADOS CORTESI</small></h1>
            </div>
            <br><br><br>
            <div class="row">
        ...
        <?php
            if($_SESSION['UserType']=="User"){
                $consultaC=ejecutarSQL::consultar("SELECT * FROM venta WHERE RUT='".$_SESSION['UserRUT']."'");
        ?>
            ...
            <p>
              ...
              <strong>Tipo de cuenta:</strong> <?php echo $datBank['TipoCuenta']; ?><br><br>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" required oninput="checkRut(this)" type="text" name="Cedclien" placeholder="RUT del cliente" maxlength="10" required="">
                </div>
                <div class="form-group">
                ...
                <?php else: ?>
                    ...
                    <input type="hidden" name="Cedclien" value="<?php echo $_SESSION['UserRUT']; ?>">
                    <div class="form-group">
                      <input type="file" name="comprobante">
                      <div class="input-group">
                        <input type="text" readonly="" class="form-control" placeholder="Seleccione la imagen del comprobante...">

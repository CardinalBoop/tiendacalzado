<?php
	...
	$SelectUser=ejecutarSQL::consultar("SELECT * FROM cliente WHERE RUT='".$code."'");
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12">
                    <div class="form-group label-floating">
                      ...
                      <input class="form-control" type="text" required readonly name="clien-rut" value="'.$DataUser['RUT'].'">
                    </div>
                  </div>

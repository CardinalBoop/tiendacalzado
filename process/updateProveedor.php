...
$rutOldProveUp=consultasSQL::clean_string($_POST['rut-prove-old']);
...
if(consultasSQL::UpdateSQL("proveedor", "NombreProveedor='$nameProveUp',Direccion='$dirProveUp',Telefono='$telProveUp',PaginaWeb='$webProveUp'", "RUTProveedor='$rutOldProveUp'")){
    echo '<script>
        swal({

    ...
    <section id="prove-product-cat-config">
        <div class="container">
          <div class="page-header">
            <h1>Panel de administración <small class="tittles-pages-logo">CALZADOS CORTESI</small></h1>
          </div>
          <!--El panel de administracion-->
          <ul class="nav nav-tabs nav-justified" style="margin-bottom: 15px;">
            <li>
              <a href="configAdmin.php?view=product">
                <i class="fa fa-cubes" aria-hidden="true"></i> &nbsp; Calzados
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="configAdmin.php?view=size">
                <i class="fa fa-shopping-basket" aria-hidden="true"></i> &nbsp; Tallas
              </a>
            </li>
            <li>
          ...
          <?php
            $content=$_GET['view'];
            $WhiteList=["product","productlist","productinfo","provider","providerlist","providerinfo","category","categorylist","categoryinfo","size","sizelist","sizeinfo","stock","stocklist","stockinfo","admin","adminlist","order","bank","account"];
            if(isset($content)){

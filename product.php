       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>PRODUCTOS <small class="tittles-pages-logo">CALZADOS CORTESI</small></h1>
            </div>
            <?php
            ...
            ?>
              <div class="row">
                <?php
                  ...
                  $consultar_productos=mysqli_query($mysqli,"SELECT DISTINCT SQL_CALC_FOUND_ROWS * FROM producto p INNER JOIN stock s ON s.CodigoProd=p.CodigoProd INNER JOIN talla t ON t.CodigoTalla=s.CodigoTalla WHERE CodigoCat='$categoria' AND p.Estado='Activo' AND p.CodigoProd GROUP BY id order by id LIMIT $inicio, $regpagina");

       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>BÚSQUEDA DE PRODUCTOS <small class="tittles-pages-logo">CALZADOS CORTESI</small></h1>
            </div>
              ...
              <div class="container-fluid">
                <div class="row">
                  <?php
                    ...
                    $consultar_productos=mysqli_query($mysqli,"SELECT DISTINCT SQL_CALC_FOUND_ROWS * FROM producto p INNER JOIN stock s ON s.CodigoProd=p.CodigoProd INNER JOIN talla t ON t.CodigoTalla=s.CodigoTalla WHERE NombreProd LIKE '%".$search."%' OR Modelo LIKE '%".$search."%' OR Marca LIKE '%".$search."%' AND p.CodigoProd GROUP BY id order by id LIMIT $inicio, $regpagina");
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-4">
                           <div class="thumbnail">
                             ...
                             <div class="caption">
                               ...
                               <p class="text-center">
                               <a href="infoProd.php?CodigoProd=<?php echo $prod['CodigoProd']; ?>&Numero=<?php echo $prod['Numero'] ?>" class="btn btn-primary btn-sm btn-raised btn-block"><i class="fa fa-plus"></i>&nbsp; Detalles</a>
                               </p>

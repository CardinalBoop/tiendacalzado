                                ...
                                <select class="form-control" name="prod-codigoP">
                                    <?php
                                        ...
                                        while($prov=mysqli_fetch_array($proveedor, MYSQLI_ASSOC)){
                                        	if($prod['RUTProveedor']==$prov['RUTProveedor']){
                                        		echo '<option selected="" value="'.$prov['RUTProveedor'].'">'.$prov['NombreProveedor'].' (Actual)</option>';
                                        	}else{
                                            	echo '<option value="'.$prov['RUTProveedor'].'">'.$prov['NombreProveedor'].'</option>';	
                                        	}
                                        }
                                    ?>
                                </select>

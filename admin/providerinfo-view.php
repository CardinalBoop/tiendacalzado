    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                ...
                <?php
                    $code=$_GET['code'];
                    $proveedor=ejecutarSQL::consultar("SELECT * FROM proveedor WHERE RUTProveedor='$code'");
                ...
                <form action="process/updateProveedor.php" method="POST" class="FormCatElec" data-form="update">
                    <input type="hidden" name="rut-prove-old" value="<?php echo $prov['RUTProveedor']; ?>">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group label-floating">
                                    <label class="control-label">RUT</label>
                                    <input class="form-control" value="<?php echo $prov['RUTProveedor']; ?>" type="text" name="prove-rut" readonly pattern="[0-9]{1,20}" maxlength="20" required="">
                                </div>
                            </div>

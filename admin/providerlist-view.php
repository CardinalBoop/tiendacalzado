                  ...
                  <table class="table table-striped table-hover">
                      	...
                      	<tbody>
							...
							<tr>
								...
								<td class="text-center"><?php echo $prov['RUTProveedor']; ?></td>
								...
								<td class="text-center">
	                        		<a href="configAdmin.php?view=providerinfo&code=<?php echo $prov['RUTProveedor']; ?>" class="btn btn-raised btn-xs btn-success">Actualizar</a>
	                        	</td>
	                        	<td class="text-center">
	                        		<form action="process/delprove.php" method="POST" class="FormCatElec" data-form="delete">
	                        			<input type="hidden" name="rut-prove" value="<?php echo $prov['RUTProveedor']; ?>">

...
?>
<nav id="navbar-auto-hidden navbar-light bg-light" >
        <div class="row hidden-xs">
            <div class="col-xs-4" >
                <p class="text-navbar tittles-pages-logo" >CALZADOS CORTESI</p>
            </div>
            <div class="col-xs-8">
              <div class="contenedor-tabla pull-right">
                <div class="contenedor-tr">
                  <a href="index" class="table-cell-td" >Inicio</a>
                  <a href="product" class="table-cell-td">Productos</a>
                  <?php
                      if(!$_SESSION['nombreAdmin']==""){
                          echo ' 
                              <a href="carrito" class="table-cell-td">Carrito</a>
                          ...
                          echo ' 
                              ...
                              <a href="#!" class="table-cell-td userConBtn" data-code="'.$_SESSION['UserRUT'].'">
                          ...
                          <a href="registration" class="table-cell-td">Registro</a>
    ...
    <div class="modal fade modal-login" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login" style="padding: 15px;">
            ...
            <form action="process/login" method="post" role="form" class="FormCatElec" data-form="login">
                <div class="form-group label-floating">
                    <label class="control-label"><span class="glyphicon glyphicon-user"></span>&nbsp;Nombre</label>
                    <input type="text" class="form-control" name="nombre-login" required="" maxlength="20">
                </div>
                <div class="form-group label-floating">
                    <label class="control-label"><span class="glyphicon glyphicon-lock"></span>&nbsp;Contraseña</label>
                    <input type="password" class="form-control" name="clave-login" required="" maxlength="20">
                </div>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg" >
        <br>
        <h3 class="text-center tittles-pages-logo">CALZADOS CORTESI</h3>
        ...
        <ul class="list-unstyled text-center">
            ...
            <?php 
                if(!$_SESSION['nombreAdmin']==""){
                    ...
                    <li><a href="#" class="glyphicon glyphicon-cog userConBtn" data-code="'.$_SESSION['UserRUT'].'"> Configuraciones</a></li>
                    ';
                }else{
    ...
    <div class="modal fade" id="ModalUpUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <form class="modal-content FormCatElec" action="process/updateClient" method="POST" data-form="save" autocomplete="off">
          <div class="modal-header">

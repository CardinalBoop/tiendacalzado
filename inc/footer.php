    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                E-mail: <a href="#" target="_blank" style="color: #5bc0de"> &nbsp; admin@calzadoscortesi.com</a>
            </div>
        </div>
    </div>
    <br><br><br>
    <h5 class="text-center tittles-pages-logo text-footer">CALZADOS CORTESI &copy; 2021</h5>
</footer>
